...
# this function calculates revenue per sold product
def get_revenue_per_product(row):
    revenue_per_product = float(row["sell_price"]) * int(row["amount"])
    return revenue_per_product

# this function return the products in sold_csv that were sold a certain date, month or year
...
# this function calculates the total revenue of all products sold on a certain date, month or year
